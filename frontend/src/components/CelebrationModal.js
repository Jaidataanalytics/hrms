...
const EVENT_VISUALS = {
  ...
  marriage_anniversary: {
    ...
    subtitle: (name) => `Dear ${name},`,
    message: 'Wishing you and your partner a beautiful day filled with love and happiness. May your bond grow stronger with each passing year!',
    cta: 'Thank You!',
    gradientFrom: '#ec4899',
    gradientTo: '#f43f5e',
    bgGradient: 'linear-gradient(135deg, #fdf2f8 0%, #fce7f3 30%, #fbcfe8 60%, #f9a8d4 100%)',
    particleColors: ['#ec4899', '#f43f5e', '#f472b6', '#fb7185', '#f9a8d4', '#fda4af'],
